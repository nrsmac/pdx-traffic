...
if TYPE_CHECKING:
  from ..models.rwis_status_site_weather_station import RwisStatusSiteWeatherStation
...
T = TypeVar("T", bound="RwisStatus")


@_attrs_define
class RwisStatus:
    """ RWIS Status Weather Station Site List

        Attributes:
            organization_information (Union[Unset, OrganizationInfo]): Organization Information
            weather_stations (Union[Unset, list['RwisStatusSiteWeatherStation']]): List of RWIS Status Weather Stations
     """

    organization_information: Union[Unset, 'OrganizationInfo'] = UNSET
    weather_stations: Union[Unset, list['RwisStatusSiteWeatherStation']] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        for weather_stations_item_data in (_weather_stations or []):
            weather_stations_item = RwisStatusSiteWeatherStation.from_dict(weather_stations_item_data)
        ...
        rwis_status.additional_properties = d
        return rwis_status
