...
T = TypeVar("T", bound="IncdStartLocation")


@_attrs_define
class IncdStartLocation:
    """ Begin Location

        Attributes:
            location_desc (Union[Unset, str]): Start location
            ...
            start_point_geometry_wkt (Union[Unset, str]): Start Point Geometry Well Known Text
     """
    ...
    start_point_geometry_wkt: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        start_point_geometry_wkt = self.start_point_geometry_wkt
        ...
        if start_point_geometry_wkt is not UNSET:
            field_dict["start-point-geometry-wkt"] = start_point_geometry_wkt
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        start_point_geometry_wkt = d.pop("start-point-geometry-wkt", UNSET)

        incd_start_location = cls(
            location_desc=location_desc,
            start_lat=start_lat,
            start_long=start_long,
            start_milepost=start_milepost,
            start_point_geometry_wkt=start_point_geometry_wkt,
        )


        incd_start_location.additional_properties = d
        return incd_start_location
