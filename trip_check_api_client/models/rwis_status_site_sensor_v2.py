...
T = TypeVar("T", bound="RwisStatusSiteSensorV2")


@_attrs_define
class RwisStatusSiteSensorV2:
    """ RWIS Status Site Sensor V2

        Attributes:
            sensor_id (Union[Unset, int]): Sensor ID
            surface_temperature (Union[Unset, int]): Surface temperature: essSurfaceTemperature, tenth degree C
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        rwis_status_site_sensor_v2 = cls(
            sensor_id=sensor_id,
            surface_temperature=surface_temperature,
        )


        rwis_status_site_sensor_v2.additional_properties = d
        return rwis_status_site_sensor_v2
