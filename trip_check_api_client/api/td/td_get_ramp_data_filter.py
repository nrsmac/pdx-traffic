...
from ...models.td_ramp_data import TDRampData
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, TDRampData]]:
    if response.status_code == 200:
        response_200 = TDRampData.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, TDRampData]]:
    return Response(
...
) -> Response[Union[Any, TDRampData]]:
    """ Traffic Detector Ramp Data

     Highway ramp data such as ramp occupancy, volume, and metering rate collected by ODOT Central Ramp
    Metering System for select ramps located in Oregon
