...
from ...models.td_inventory import TDInventory
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[Any, TDInventory]]:
    if response.status_code == 200:
        response_200 = TDInventory.from_dict(response.json())
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[Any, TDInventory]]:
    return Response(
...
) -> Response[Union[Any, TDInventory]]:
    """ Traffic Detector Inventory Data

     Name and location of traffic detector stations and highway ramps associated with them.
...
) -> Optional[Union[Any, TDInventory]]:
    """ Traffic Detector Inventory Data
